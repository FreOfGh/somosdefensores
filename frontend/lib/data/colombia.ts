...
// Usado en los formularios para las listas desplegables de ubicación.
...
export const MUNICIPIOS_POR_DEPARTAMENTO: Record<string, string[]> = {
  ...
  "Antioquia": [
    ...
    "Olaya", "Peñol", "Peque", "Pueblorrico", "Puerto Berrío",
  ...
  "Boyacá": [
    ...
    "Cuítiva", "Duitama", "El Cocuy", "El Espino", "Firavitoba",
    "Floresta", "Gachantivá", "Gámeza", "Garagoa", "Guacamayas",
    "Guateque", "Guayatá", "Güicán", "Iza", "Jenesano", "Jericó",
    ...
    "Páez", "Paipa", "Pajarito", "Panqueba", "Pauna", "Paya",
    "Paz de Río", "Pesca", "Pisba", "Puerto Boyacá", "Quípama",
    ...
    "Turmequé", "Tuta", "Tutazá", "Úmbita", "Ventaquemada",
  ...
  "Casanare": [
    ...
    "Nunchía", "Orocué", "Paz de Ariporo", "Pore", "Recetor",
  ...
  "Nariño": [
    ...
    "Cuaspud", "Cumbal", "Cumbitara", "El Charco", "El Peñol",
  ...
  "Valle del Cauca": [
    ...
    "Buenaventura", "Bugalagrande", "Caicedonia", "Cali", "Calima",
    "Candelaria", "Cartago", "Dagua", "El Águila", "El Cairo",
    "El Cerrito", "El Dovio", "Florida", "Ginebra", "Guacarí",
    "Guadalajara de Buga", "Jamundí", "La Cumbre", "La Unión",
...
export const TIPOS_DOCUMENTO_IDENTIDAD = [
  ...
  { value: "PPT", label: "Permiso por Protección Temporal (P.P.T.)" },
  { value: "PEP", label: "Permiso Especial de Permanencia (P.E.P.)" },
...
export const PARENTESCOS = [
  ...
  { value: "conyuge", label: "Cónyuge / compañero(a) permanente" },
